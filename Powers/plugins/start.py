...
You can donate by contacting my owner: [Siam Chowdhury](http://t.me/Chowdhury_Siam)
     """
...
async def start(c: Gojo, m: Message):
    ...
    if m.chat.type == ChatType.PRIVATE:
        ...
        try:
            cpt = f"""
Hey [{m.from_user.first_name}](http://t.me/{m.from_user.username})! I am Rin Tohsaka ✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!

Join my [Anime Kun Channel](https://t.me/Anime_Kun_Channel) to get information on all the latest updates."""
...
async def start_back(_, q: CallbackQuery):
    try:
        cpt = f"""
Hey [{q.from_user.first_name}](http://t.me/{q.from_user.username})! I am Rin Tohsaka ✨.
I'm here to help you manage your group(s)!
Hit /help to find out more about how to use me in my full potential!

Join my [Anime Kun Channel](http://t.me/Anime_Kun_Channel) to get information on all the latest updates."""
